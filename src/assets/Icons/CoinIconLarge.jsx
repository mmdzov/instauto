...
const CoinIconLarge = () => {
  return (
    <Container>
      <div className="coinLargeLabel">TA</div>
      <svg
      ...
      >
        ...
        >
          <path
            d="M 82.355 31.82 c 1.654 0 3 1.346 3 3 c 0 1.654 -1.346 3 -3 3 c -1.654 0 -3 -1.346 -3 -3 C 79.355 33.165 80.701 31.82 82.355 31.82 z"
            style={{
              stroke: "none",
              strokeWidth: 1,
              strokeDasharray: "none",
          ...
          />
          <path
            d="M 65.728 19.935 c 1.654 0 3 1.346 3 3 c 0 1.654 -1.346 3 -3 3 c -1.654 0 -3 -1.346 -3 -3 C 62.729 21.281 64.074 19.935 65.728 19.935 z"
            style={{
              stroke: "none",
              strokeWidth: 1,
              strokeDasharray: "none",
          ...
          />
          <path
            d="M 54.337 2.114 c 1.654 0 3 1.346 3 3 s -1.346 3 -3 3 c -1.654 0 -3 -1.346 -3 -3 S 52.682 2.114 54.337 2.114 z"
            style={{
              stroke: "none",
              strokeWidth: 1,
              strokeDasharray: "none",
          ...
          />
          <path
            d="M 21.271 22.935 c 0 -1.654 1.346 -3 3 -3 s 3 1.346 3 3 c 0 1.654 -1.346 3 -3 3 S 21.271 24.59 21.271 22.935 z"
            style={{
              stroke: "none",
              strokeWidth: 1,
              strokeDasharray: "none",
          ...
          />
          <path
            d="M 5.114 38.664 c -1.654 0 -3 -1.346 -3 -3 s 1.346 -3 3 -3 c 1.654 0 3 1.346 3 3 S 6.768 38.664 5.114 38.664 z"
            style={{
              stroke: "none",
              strokeWidth: 1,
              strokeDasharray: "none",
          ...
          />
          <path
            d="M 7.645 58.18 c -1.654 0 -3 -1.346 -3 -3 c 0 -1.654 1.346 -3 3 -3 c 1.654 0 3 1.346 3 3 C 10.645 56.835 9.299 58.18 7.645 58.18 z"
            style={{
              stroke: "none",
              strokeWidth: 1,
              strokeDasharray: "none",
          ...
          />
          <path
            d="M 24.271 70.065 c -1.654 0 -3 -1.346 -3 -3 c 0 -1.654 1.346 -3 3 -3 s 3 1.346 3 3 C 27.271 68.719 25.926 70.065 24.271 70.065 z"
            style={{
              stroke: "none",
              strokeWidth: 1,
              strokeDasharray: "none",
          ...
          />
          <path
            d="M 35.664 87.886 c -1.654 0 -3 -1.346 -3 -3 c 0 -1.654 1.346 -3 3 -3 c 1.654 0 3 1.346 3 3 C 38.663 86.54 37.318 87.886 35.664 87.886 z"
            style={{
              stroke: "none",
              strokeWidth: 1,
              strokeDasharray: "none",
          ...
          />
          <path
            d="M 58.18 82.355 c 0 1.654 -1.346 3 -3 3 c -1.654 0 -3 -1.346 -3 -3 c 0 -1.654 1.346 -3 3 -3 C 56.835 79.355 58.18 80.701 58.18 82.355 z"
            style={{
              stroke: "none",
              strokeWidth: 1,
              strokeDasharray: "none",
          ...
          />
          <path
            d="M 68.729 67.065 c 0 1.654 -1.346 3 -3 3 c -1.654 0 -3 -1.346 -3 -3 c 0 -1.654 1.346 -3 3 -3 C 67.383 64.065 68.729 65.41 68.729 67.065 z"
            style={{
              stroke: "none",
              strokeWidth: 1,
              strokeDasharray: "none",
          ...
          <ellipse
            ...
            transform=" matrix(0.1602 -0.9871 0.9871 0.1602 -6.5226 82.1218) "
          />
          <path
            d="M 84.886 57.337 c -1.654 0 -3 -1.346 -3 -3 s 1.346 -3 3 -3 c 1.654 0 3 1.346 3 3 S 86.541 57.337 84.886 57.337 z"
            style={{
              stroke: "none",
              strokeWidth: 1,
              strokeDasharray: "none",
